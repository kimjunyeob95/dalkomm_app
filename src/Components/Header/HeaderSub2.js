...
export default function HeaderSub2({ title, type, icon, location, noBack, location2, icon2, directUrl }) {
  ...
  return (
    <header id="header" className="header">
      ...
      {!noBack ? (
        ...
        <button type="button" className="btn back" onClick={() => history.push(directUrl)}>
          <i className="ico back">
            <span className="blind">뒤로</span>
          </i>
        </button>
