		...
		<div className="modal-wrap">
            ...
            <div className="modal-body">
                <div className="content-wrap">
                    ...
                    <div className="btn-area">
                        <button type="button" className="btn dark large full close-modal event-start" pop-target="#CoffeeTreeGame">커피나무 키우러 가기</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div className="content-wrap">
                    ...
                    */}
                        ...
                        <ul className="btn-area ingredient-list">
                            ...
                            <li className="active"> {/* [D] 커피나무 키우기 액션 .active 활성화 */}
                                <button type="button" className="btn harvest">
                                    <svg viewBox="0 0 24 24">
                                        <path className="path-transparent" d="M430 354h-24v-24h24v24z" transform="translate(-406 -330)"/>
                                        <g>
            ...
            <div className="popup-body">
                ...
                <ul className="data-list col">
                    <li>
                        ...
                        {/* [D] 수확한 열매 색상
                            .item.fruit.yellow : Yellow 열매
                            .item.fruit.orange : Orange 열매
                            .item.fruit.pink   : Pink 열매
                            .item.fruit.red    : Red 열매
                            .item.fruit.purple : Purple 열매
                         */}
                ...
                <p className="text">Yellow, Orange, Pink 열매를 획득했어요.</p>
            </div>
            ...
            <div className="modal-body">
                <div className="content-wrap">
                    <div className="section title-wrap">
                        <h2 className="section-title large">
                            총 <span className="number fc-orange">74</span>개의 열매를<br />
                            모으셨어요!
                        </h2>
                    </div>
                    ...
                    <div className="section state-wrap">
                        ...
                        <div className="section fruit-bar">
                            <div className="bar">
                                ...
                                <span className="bar-state" style={{width:"90%"}}> {/* [D] 0%일때 ' style="width:0%" ' 으로 반영되어야 디자인에 맞는 화면으로 나옵니다. */}
                                    <em className="num">90%</em>
                                </span>
                            </div>

                            <div className="text">열매 1개 더 모으면 참여 완료!</div>
                        </div>
                            ...
                            <li>
                                <div className="item fruit yellow">
                                    ...
                                    <div className="number">
                                        <span className="fc-orange">30</span>개
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="item fruit orange">
                                    ...
                                    <div className="number">
                                        <span className="fc-orange">24</span>개
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="item fruit pink">
                                    ...
                                    <div className="number">
                                        <span className="fc-orange">15</span>개
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="item fruit red" >
                                    ...
                                    <div className="number">
                                        <span className="fc-orange">5</span>개
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="item fruit purple" >
                                    ...
                                    <div className="number">
                                        <span className="fc-orange">0</span>개
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div className="btn-area active">
                        <button type="button" className="btn dark large full close-modal fruit-change">열매 교환하기</button>
                        ...
                        >
                                <ul className="swiper-wrapper data-list">
                                    <li className="swiper-slide">
                                        <div className="item fruit yellow">
                                            <div className="chart-wrap">
                                                <div className="fruit-chart" data-percent="100"></div>
                                                <div className="img-wrap"></div>
                                            </div>
                                            <div className="data-wrap">
                                                <span className="name en">Yellow</span>
                                                <span className="number">30개</span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li className="swiper-slide">
                                        <div className="item fruit orange">
                                            <div className="chart-wrap">
                                                <div className="fruit-chart" data-percent="75"></div>
                                                <div className="img-wrap"></div>
                                            </div>
                                            <div className="data-wrap">
                                                <span className="name en">Orange</span>
                                                <span className="number">24개</span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li className="swiper-slide">
                                        <div className="item fruit pink">
                                            <div className="chart-wrap">
                                                <div className="fruit-chart" data-percent="50"></div>
                                                <div className="img-wrap"></div>
                                            </div>
                                            <div className="data-wrap">
                                                <span className="name en">Pink</span>
                                                <span className="number">15개</span>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li className="swiper-slide">
                                        <div className="item fruit red" >
                                            <div className="chart-wrap">
                                                <div className="fruit-chart" data-percent="15"></div>
                                                <div className="img-wrap"></div>
                                            </div>
                                            <div className="data-wrap">
                                                <span className="name en">Red</span>
                                    ...
                                    <li className="swiper-slide">
                                        <div className="item fruit purple" >
                                            <div className="chart-wrap">
                                                <div className="fruit-chart" data-percent="0"></div>
                                                <div className="img-wrap"></div>
                                            </div>
                                            <div className="data-wrap">
                                                <span className="name en">Purple</span>
                                                <span className="number">0개</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div className="section fruit-exchange">
                        <div className="fruit-red">
                            ...
                            <ul className="data-list">
                                <li className="exchange"> {/* [D] 열매 교환 가능시 .exchange 활성화 */}
                                    <div className="item fruit-ticket">
                                        <div className="fruit-wrap">
                                            ...
                                            <div className="text-wrap">
                                                ...
                                                <p className="text">열매 1개를 교환할 수 있어요.</p>
                                            </div>
                                        </div>
                                        <div className="data-wrap">
                                            <button type="button" className="btn fruit-red">
                                    ...
                                    <div className="item fruit-ticket">
                                        <div className="fruit-wrap">
                                            ...
                                            <div className="text-wrap">
                                                ...
                                                <p className="text">열매가 부족해요.</p>
                                            </div>
                                        </div>
                                        <div className="data-wrap">
                                            <button type="button" className="btn open-pop" pop-target="#layerChange">
                                                <p className="data">교환</p>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <ul className="data-list">
                                <li className="exchange"> {/* [D] 열매 교환 가능시 .exchange 활성화 */}
                                    <div className="item fruit-ticket">
                                        ...
                                        <div className="data-wrap">
                                            <button type="button" className="btn close-modal fruit-pruple">
                                                <p className="data">교환</p>
                                            </button>
                                        </div>
                                    </div>
